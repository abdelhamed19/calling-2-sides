    ...
    (t.Foundation = {
      ...
      init: function (e, n, r, i, o) {
        ...
        if (n && typeof n == "string" && !/reflow/i.test(n))
          this.libs.hasOwnProperty(n) && a.push(this.init_lib(n, u));
        else for (var f in this.libs) a.push(this.init_lib(f, n));
        return (
          s(t).load(function () {
            s(t)
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.dropdown = {
      ...
      events: function (n) {
        ...
        i(this.scope)
          ...
          .on(
            ...
            function (e) {
              ...
              clearTimeout(r.timeout),
                t.data(r.data_attr())
                  ? ((n = i("#" + t.data(r.data_attr()))), (s = t))
                  : ((n = t),
                    (s = i("[" + r.attr_name() + "='" + n.attr("id") + "']")));
              var o = s.data(r.attr_name(!0) + "-init") || r.settings;
              i(e.target).data(r.data_attr()) &&
                o.is_hover &&
                r.closeall.call(r),
                o.is_hover && r.open.apply(r, [n, s]);
            }
          )
          .on(
              ...
              r.timeout = setTimeout(
                function () {
                  if (t.data(r.data_attr())) {
                    ...
                    e.is_hover &&
                      r.close.call(r, i("#" + t.data(r.data_attr())));
                  } else {
                    var n = i(
                        "[" + r.attr_name() + '="' + i(this).attr("id") + '"]'
                      ),
          ...
          .on("click.fndtn.dropdown", function (t) {
            ...
            if (i(t.target).closest("[" + r.attr_name() + "]").length > 0)
              return;
            if (
              !i(t.target).data("revealId") &&
              n.length > 0 &&
              (i(t.target).is("[" + r.attr_name() + "-content]") ||
      ...
      close: function (e) {
        var t = this;
        e.each(function () {
          t.S(this).hasClass(t.settings.active_class) &&
            (t
              .S(this)
              .css(Foundation.rtl ? "right" : "left", "-99999px")
              .removeClass(t.settings.active_class)
              .prev("[" + t.attr_name() + "]")
              .removeClass(t.settings.active_class)
              .removeData("target"),
            t.S(this).trigger("closed").trigger("closed.fndtn.dropdown", [e]));
        });
      },
      closeall: function () {
        var t = this;
      ...
      open: function (e, t) {
        this.css(e.addClass(this.settings.active_class), t),
          e
            .prev("[" + this.attr_name() + "]")
          ...
          e
            .data("target", t.get(0))
            .trigger("opened")
            .trigger("opened.fndtn.dropdown", [e, t]);
      },
      data_attr: function () {
      ...
      toggle: function (e) {
        ...
        this.close.call(
          this,
          this.S("[" + this.attr_name() + "-content]").not(t)
        ),
          t.hasClass(this.settings.active_class)
            ? (this.close.call(this, t),
              t.data("target") !== e.get(0) && this.open.call(this, t, e))
            : this.open.call(this, t, e);
      },
      resize: function () {
      ...
      dirs: {
        ...
        top: function (e, t) {
          ...
          return (
            ...
            (e.outerWidth() < this.outerWidth() || n.small()) &&
              n.adjust_pip(i, r),
            Foundation.rtl
              ? {
              ...
              : { left: r.left, top: r.top - this.outerHeight() }
          );
        },
        bottom: function (e, t) {
          var n = Foundation.libs.dropdown,
          ...
          return (
            ...
            n.rtl
              ...
              : { left: r.left, top: r.top + e.outerHeight() }
          );
        },
        left: function (e, t) {
        ...
        right: function (e, t) {
          ...
          return (
            ...
            { left: n.left + e.outerWidth(), top: n.top }
          );
        },
      },
      adjust_pip: function (e, t) {
        ...
        var r = ".f-dropdown.open:before",
          ...
          o = "left: " + (e - 1) + "px;";
        n.insertRule
          ? (n.insertRule([r, "{", s, "}"].join(" "), this.rule_idx),
            n.insertRule([i, "{", o, "}"].join(" "), this.rule_idx + 1))
          : (n.addRule(r, s, this.rule_idx),
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.reveal = {
      ...
      open: function (t, n) {
        ...
        s = s || this.settings;
        if (i.hasClass("open") && t.attr("data-reveal-id") == i.attr("id"))
          return r.close(i);
        if (!i.hasClass("open")) {
